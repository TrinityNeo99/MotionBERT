...
class DataReaderBinocular(object):
    ...
    def read_2d(self):
        ...
        return trainset_left, trainset_right, testset_left, testset_right
    ...
    def get_sliced_data(self):
        train_data_left, train_data_right, test_data_left, test_data_right = self.read_2d()  # train_data (1559752, 17, 3) test_data (566920, 17, 3)
        ...
        return train_data_left, train_data_right, test_data_left, test_data_right, train_labels, test_labels
