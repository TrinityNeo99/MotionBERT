...
def save_clips(subset_name, root_path, data_lefts, data_rights, data_labels):
...
datareader = DataReaderBinocular(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243,
                                 dt_file="coco_17_binocular_align_all_3.7_fix.pkl",
...
train_data_left, train_data_right, test_data_left, test_data_right, train_labels, test_labels = datareader.get_sliced_data()
...
root_path = "../../dataset/binocular_data/sports/binocular_f243s81/binocular_align_all_3.7_fix"
if not os.path.exists(root_path):
    os.makedirs(root_path)

save_clips("train", root_path, train_data_left, train_data_right, train_labels)
save_clips("test", root_path, test_data_left, test_data_right, test_labels)
