...
from lib.data.datareader_binocular_depth import DataReaderBinocular
from tqdm import tqdm


def save_clips(subset_name, root_path, data_lefts, data_rights, data_labels, data_depths):
    ...
    for i in tqdm(range(len_data)):
        data_left, data_right, data_label, data_depth = data_lefts[i], data_rights[i], data_labels[i], data_depths[i]
        data_dict = {
            "data_left": data_left,
...
datareader = DataReaderBinocular(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243,
                                 dt_file="coco_17_binocular_depth.pkl",
...
train_data_left, train_data_right, test_data_left, test_data_right, train_labels, test_labels, train_depths, test_depths = datareader.get_sliced_data()
...
# root_path = "/mnt/weijiangning-pose-estimation-data/dual_camera_data/sports/binocular_f243s81/binocular_depth"
root_path = "../../dataset/binocular_data/sports/binocular_f243s81/binocular_depth"
# root_path = "/root/wjn/home/2024-human-pose-estimation-tutorial/MotionBERT/data/motion3d"
if not os.path.exists(root_path):
    os.makedirs(root_path)

save_clips("train", root_path, train_data_left, train_data_right, train_labels, train_depths)
save_clips("test", root_path, test_data_left, test_data_right, test_labels, test_depths)
